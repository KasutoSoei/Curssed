...
class FavProductController extends AbstractController
{
    ...
    public function favoriteProduct(int $id, EntityManagerInterface $entityManager): JsonResponse
    {
        $user = $this->getUser();  
...
public function unfavoriteProduct(int $id, EntityManagerInterface $entityManager): JsonResponse
{
    ...
    public function favoriteProducts(EntityManagerInterface $entityManager): Response
    {
        $user = $this->getUser();
        $likedProducts = $user->getLikedProducts(); 

        return $this->render('fav_product/index.html.twig', [
